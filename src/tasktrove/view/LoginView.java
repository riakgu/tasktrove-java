...
public class LoginView extends javax.swing.JFrame {
   ...
   private AuthController ac = new AuthController();
    ...
    private void initComponents() {
        ...
        jPanel2.setBackground(new java.awt.Color(0, 196, 238));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String username = jTextField1.getText(); // assuming jTextField1 is the username field
        String password = new String(jPasswordField1.getPassword()); // assuming jPasswordField1 is the password field
        ...
        // Check credentials
        if (ac.authenticateUser(username, password)) {
